...
As we can see `1=1 is true` it shows a response, `1=2 is false` no response. But even the true, injecting random numbers and letters, using null does not show any results for column or row, which identifies as `Blind SQL`
